start_server {tags {"ex_hash"} overrides {bind 0.0.0.0} } {
    ...
    test {Active expire rdb} {
        ...
        # 验证在rdb reload之后Active expire是否能recovery
        r bgsave
        waitForBgsave r
        r debug reload
    ...
    test {Active expire aof} {
        ...
        # aof rewrite and reload之后Active expire是否能recovery
        r bgrewriteaof
    ...
    test {Exhdel} {
        ...
        set del_num [r exhdel exhashkey field1 field2 field3]
        assert_equal 2 $del_num

        set exist_num [r exists exhashkey]
        assert_equal 0 $exist_num

        set del_num [r exhdel exhashkey_none field1]
        assert_equal 0 $del_num
    }
                                                                ...
                                                                test {EXHINCRBYFLOAT fails against hash value with spaces (left)} {
                                                                    ...
                                                                    test {EXHINCRBYFLOAT fails against hash value with spaces (right)} {
                                                                        ...
                                                                        test {Exhkeys / exhvals / exhgetall basic} {
                                                                            ...
                                                                            assert_equal [] [r exhgetall2 exhashkey_noexists]
                                                                        ...
                                                                        test {Exhscan basic} {
                                                                            ...
                                                                            assert_equal 1 [r exhset exhashkey field1 val1]
                                                                            assert_equal 1 [r exhset exhashkey field2 val2 EX 2]

                                                                            set scan_result [r exhscan exhashkey ^ xxx]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field ""
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field1 val1 field2 val2}]
                                                                            ...
                                                                            assert_equal $next_field ""
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field1 val1}]
                                                                        }

                                                                        test {Exhscan while expired fields exist} {
                                                                            r del exhashkey

                                                                            set scan_result [r exhscan noexists ^ xxx]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field ""
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {}]

                                                                            assert_equal 1 [r exhset exhashkey field1 val1 PX 500]
                                                                            assert_equal 1 [r exhset exhashkey field2 val2 PX 500]
                                                                            assert_equal 1 [r exhset exhashkey field3 val3]
                                                                            ...
                                                                            assert_equal $next_field ""
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field3 val3}]

                                                                            set res [r exhlen exhashkey]
                                                                            assert_equal $res 1
                                                                        }

                                                                        test {Exhscan traversal all} {
                                                                            r del exhashkey

                                                                            assert_equal 1 [r exhset exhashkey field1 val1]
                                                                            assert_equal 1 [r exhset exhashkey field2 val2]
                                                                            assert_equal 1 [r exhset exhashkey field3 val3]
                                                                            assert_equal 1 [r exhset exhashkey field4 val4]
                                                                            assert_equal 1 [r exhset exhashkey field5 val5]
                                                                            assert_equal 1 [r exhset exhashkey field6 val6]
                                                                            assert_equal 1 [r exhset exhashkey field7 val7]
                                                                            assert_equal 1 [r exhset exhashkey field8 val8]
                                                                            assert_equal 1 [r exhset exhashkey field9 val9]

                                                                            set scan_result [r exhscan exhashkey ^ xxx COUNT 3]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field4
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field1 val1 field2 val2 field3 val3}]

                                                                            set scan_result [r exhscan exhashkey >= $next_field COUNT 3]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field7
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field4 val4 field5 val5 field6 val6}]

                                                                            set scan_result [r exhscan exhashkey >= $next_field COUNT 3]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field ""
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field7 val7 field8 val8 field9 val9}]
                                                                        }
                                                                        ...
                                                                        test {Exhscan noval} {
                                                                            ...
                                                                            set scan_result [r exhscan exhashkey ^ xxx COUNT 2 noval]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field6
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal $content []

                                                                            set scan_result [r exhscan exhashkey >= $next_field COUNT 2 noval]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field ""
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal $content []
                                                                        ...
                                                                        test {Exhscan traversal when insert and del} {
                                                                            r del exhashkey
                                                                            ...
                                                                            set scan_result [r exhscan exhashkey ^ xxx COUNT 3]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field8
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field1 val1 field2 val2 field6 val6}]
                                                                            ...
                                                                            assert_equal $next_field ""
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field8 val8 field9 val9}]
                                                                            ...
                                                                            assert_equal 1 [r exhdel exhashkey field6]
                                                                            set scan_result [r exhscan exhashkey >= $next_field COUNT 3]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field ""
                                                                            set content [lindex $scan_result 1]
                                                                        ...
                                                                        test {Exhscan with dir control} {
                                                                            r del exhashkey
                                                                            assert_equal OK [r exhmset exhashkey 1_f 1_v 2_f 2_v 3_f 3_v 4_f 4_v 5_f 5_v 6_f 6_v 7_f 7_v 8_f 8_v 9_f 9_v ]
                                                                            assert_equal 1 [r exhexpire exhashkey 2_f 3]
                                                                            assert_equal 1 [r exhexpire exhashkey 5_f 3]
                                                                            assert_equal 1 [r exhexpire exhashkey 7_f 3]

                                                                            assert_equal 9 [r exhlen exhashkey]

                                                                            after 3000

                                                                            assert_equal 9 [r exhlen exhashkey]
                                                                            assert_equal 6 [r exhlen exhashkey noexp]

                                                                            set cur 4
                                                                            set keys {}
                                                                            while 1 {
                                                                                set res [r exhscan exhashkey >= $cur count 2 DIR right]
                                                                            ...
                                                                            assert_equal {4_f 4_v 6_f 6_v 8_f 8_v 9_f 9_v} $keys
                                                                            assert_equal 7 [r exhlen exhashkey]

                                                                            set cur 4
                                                                            set keys {}
                                                                            while 1 {
                                                                                set res [r exhscan exhashkey <= $cur count 2 DIR left]
                                                                                set cur [lindex $res 0]
                                                                                set k [lindex $res 1]
                                                                                lappend keys {*}$k
                                                                                if {$cur == ""} break
                                                                            ...
                                                                            assert_equal {3_f 3_v 1_f 1_v} $keys
                                                                            assert_equal 6 [r exhlen exhashkey]
                                                                        }

                                                                        test {Exhscan MATCH pattern} {
                                                                            r del exhashkey

                                                                            assert_equal 1 [r exhset exhashkey field1_1 val1_1]
                                                                            assert_equal 1 [r exhset exhashkey field1_2 val1_2]
                                                                            assert_equal 1 [r exhset exhashkey field1_3 val1_3]
                                                                            assert_equal 1 [r exhset exhashkey field1_4 val1_4]
                                                                            assert_equal 1 [r exhset exhashkey field1_5 val1_5]
                                                                            assert_equal 1 [r exhset exhashkey field2_1 val2_1]
                                                                            assert_equal 1 [r exhset exhashkey field2_2 val2_2]
                                                                            assert_equal 1 [r exhset exhashkey field2_3 val2_3]
                                                                            assert_equal 1 [r exhset exhashkey field6_1 val6_1]
                                                                            assert_equal 1 [r exhset exhashkey field6_2 val6_2]
                                                                            assert_equal 1 [r exhset exhashkey field6_3 val6_3]
                                                                            assert_equal 1 [r exhset exhashkey field6_4 val6_4]
                                                                            assert_equal 1 [r exhset exhashkey field8_1 val8_1]
                                                                            assert_equal 1 [r exhset exhashkey field8_2 val8_4]

                                                                            # start
                                                                            set scan_result [r exhscan exhashkey ^ xxx COUNT 3 MATCH field1_1]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field1_4
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field1_1 val1_1}]

                                                                            set scan_result [r exhscan exhashkey >= $next_field COUNT 3 MATCH field1_1]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field2_2
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {}]

                                                                            set scan_result [r exhscan exhashkey >= $next_field COUNT 3 MATCH field1_1]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field6_2
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {}]

                                                                            set scan_result [r exhscan exhashkey >= $next_field COUNT 3 MATCH field1_1]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field8_1
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {}]
                                                                            ...
                                                                            # start
                                                                            set scan_result [r exhscan exhashkey ^ xxx COUNT 3 MATCH field6_*]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field1_4
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {}]

                                                                            set scan_result [r exhscan exhashkey >= $next_field COUNT 3 MATCH field6_*]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field2_2
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {}]
                                                                            ...
                                                                            assert_equal $next_field field6_2
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field6_1 val6_1}]

                                                                            set scan_result [r exhscan exhashkey >= $next_field COUNT 3 MATCH field6_*]
                                                                            set next_field [lindex $scan_result 0]
                                                                            assert_equal $next_field field8_1
                                                                            set content [lindex $scan_result 1]
                                                                            assert_equal [lsort $content] [lsort {field6_2 val6_2 field6_3 val6_3 field6_4 val6_4}]
                                                                    ...
                                                                    start_server {tags {"exhash repl"} overrides {bind 0.0.0.0}} {
                                                                        ...
                                                                        start_server { overrides {bind 0.0.0.0}} {
                                                                            ...
                                                                            test {Exhset/exhget master-slave} {
                                                                                ...
                                                                                $master exh_debug_set_enable_active_expire 0
                                                                            ...
                                                                            test {Active expire master-slave} {
                                                                                $master select 0
                                                                                $master del exhashkey
                                                                                $master exh_debug_set_enable_active_expire 1
